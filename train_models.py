...
# You can download it from: https://archive.ics.uci.edu/ml/datasets/wine+quality
...
try:
    ...
    try:
        ...
        print("Please download manually from: https://archive.ics.uci.edu/ml/datasets/wine+quality")
        df = None
